...
9. **Сводка — модель Haiku.** Если diff непустой, запусти сабагента через Agent tool с `model: "haiku"` и передай ему только готовый diff из шага 6. Задача сабагента — чисто форматирование: превратить diff в короткий человеко-читаемый текст (одна строка на изменение: товар, ссылка на товар, поле, было → стало, %), без повторного анализа и без новых выводов
10. Отправка:
